...
export interface IRouterClient {
     ...
     *
     */
    transmit(toChannel: string, event: any, options?: {
     ...
     *
     */
    addPubSubResponder(topic: string | RegExp, initialState?: object, params?: {
     ...
     *
     */
    subscribe(topic: string, notifyCallback: StandardCallback): {
        subscribeID: string;
        topic: string;
    };
    /**
