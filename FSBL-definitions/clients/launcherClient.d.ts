...
export declare class LauncherClient extends BaseClient {
     ...
     */
    toggleWindowOnClick(element: HTMLElement | NodeSelector, windowIdentifier: WindowIdentifier, params: SpawnParams): void;
    /**
     ...
     */
    showWindow(windowIdentifier: WindowIdentifier, params: ShowWindowParams, cb?: Function): Promise<{}>;
    /**
    ...
    *
    */
    getActiveDescriptors(cb?: Function): Promise<{}>;
    /**
